...
CREATE TABLE `__new_classes` (
	...
	`created_at` integer DEFAULT '"2025-07-01T20:29:53.038Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-07-01T20:29:53.038Z"' NOT NULL,
	FOREIGN KEY (`student_id`) REFERENCES `students`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`pack_id`) REFERENCES `packs`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
INSERT INTO `__new_classes`("id", "student_id", "date", "duration_minutes", "topic", "pack_id", "price_value", "price_currency", "notes", "is_paid", "created_at", "updated_at") SELECT "id", "student_id", "date", "duration_minutes", "topic", "pack_id", "price_value", "price_currency", "notes", "is_paid", "created_at", "updated_at" FROM `classes`;--> statement-breakpoint
...
CREATE TABLE `__new_packs` (
	...
	`notes` text,
	`created_at` integer DEFAULT '"2025-07-01T20:29:53.039Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-07-01T20:29:53.039Z"' NOT NULL,
	FOREIGN KEY (`student_id`) REFERENCES `students`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
